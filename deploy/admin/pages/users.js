...
exports.userFormPage = exports.usersPage = void 0;
const layout_js_1 = require("../layout.js");
const usersPage = (users, role = 'admin') => {
  ...
  `;
    return (0, layout_js_1.layout)('用户管理', content, 'users', role);
};
exports.usersPage = usersPage;
const userFormPage = (user, error, role = 'admin') => {
    const isEdit = !!user;
  ...
  `;
    return (0, layout_js_1.layout)(title, content, 'users', role);
};
exports.userFormPage = userFormPage;
