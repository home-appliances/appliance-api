...
exports.productImageFormPage = exports.productImagesPage = void 0;
const layout_js_1 = require("../layout.js");
const productImagesPage = (images, products, role = 'admin', filterProductId) => {
  ...
  `;
    return (0, layout_js_1.layout)('图片管理', content, 'product-images', role);
};
exports.productImagesPage = productImagesPage;
const productImageFormPage = (image, products = [], error, role = 'admin') => {
    const isEdit = !!image;
  ...
  `;
    return (0, layout_js_1.layout)(title, content, 'product-images', role);
};
exports.productImageFormPage = productImageFormPage;
