...
exports.categoryFormPage = exports.categoriesPage = void 0;
const layout_js_1 = require("../layout.js");
const categoriesPage = (categories, role = 'admin') => {
    // 构建树形结构
  ...
  `;
    return (0, layout_js_1.layout)('分类管理', content, 'categories', role);
};
exports.categoriesPage = categoriesPage;
const categoryFormPage = (category, categories = [], error, role = 'admin') => {
  ...
  `;
    return (0, layout_js_1.layout)(title, content, 'categories', role);
};
exports.categoryFormPage = categoryFormPage;
