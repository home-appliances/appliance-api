...
exports.productFormPage = exports.productsPage = void 0;
const layout_js_1 = require("../layout.js");
const productsPage = (products, page, total, pageSize, role = 'admin', filters = {}, brands = []) => {
  ...
  `;
    return (0, layout_js_1.layout)('产品管理', content, 'products', role);
};
exports.productsPage = productsPage;
const productFormPage = (product, error, role = 'admin', categories = []) => {
  ...
  `;
    return (0, layout_js_1.layout)(title, content, 'products', role);
};
